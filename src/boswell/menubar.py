...
class BoswellApp(rumps.App):
    def __init__(self) -> None:
        super().__init__(APP_NAME, title=f"{APP_NAME} · Idle", quit_button="Quit")
    ...
    def on_start(self, _sender: rumps.MenuItem) -> None:
        ...
        # without rendering). Auto-name from the current day+time; user can
        # rename the folder afterward.
        ...
        try:
            ...
            self.recorder = Recorder(dev, paths.audio_path(self.meeting_dir))
            self.recorder.start()
